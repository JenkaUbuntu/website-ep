# Vorreiter-Rolle in der Klimapolitik – Argumentanalyse einer aktuellen Kontroverse
...
**Ja!** schreibt der Deutsche Ethikrat in seiner [Stellungnahme Klimagerechtigkeit](Gutachten%20Klimagerechtigkeit).[^2]

**Nein!** [schreiben die Ökonomen Axel Ockenfels und Christoph M. Schmidt](https://www.degruyterbrill.com/document/doi/10.1515/zfwp-2019-2017/html) sowie die [Rechtswissenschaftlerin Frauke Rostalski](https://rostalski.jura.uni-koeln.de/prof-dr-dr-frauke-rostalski)[^3].
...
- So wirft Rostalski den Befürworter\*innen der Stellungnahme des Ethikrates vor, eine moralische Position zu vertreten, die dem gesunden Menschenverstand widerspricht: Gesinnungsethik ohne Rücksicht auf die Konsequenzen eigenen Handelns[^4];

- hingegen haben [einige Mitglieder des Ethikrates in ihrer Verteidigung](https://www.sueddeutsche.de/wissen/klimaschutz-verantwortung-einzelner-ethikrat-li.3342427) der These, dass Deutschland eine Vorreiter-Rolle in der Klimapolitik einnehmen sollte, Rostalski vorgeworfen, etablierte Standards rationalen Argumentierens zu verletzen[^5].
...
> **TIP:**
>
> Klimapolitischer Alleingang[^7] eines Staates wie Deutschland führt dazu, dass wirksamer globaler Klimaschutz – beispielsweise Erreichen des Pariser Klimaschutzziels – induziert wird.
>
> > **IMPORTANT:**
> >
...
> >   - Die Gegner\*innen suggerieren in manchen Formulierungen, den Befürworter\*innen diese starke These zu unterstellen[^8].

> **TIP:**
>
> Klimapolitischer Alleingang eines Staates wie Deutschland führt dazu, dass jede in Deutschland eingesparte Einheit an Treibhausgasemissionen die globalen Treibhausgasemissionen um diese Einheit reduziert[^9].
>
> > **IMPORTANT:**
> >
> > Aufgrund des Europäischen Emissionshandels (Wasserbett-Effekt) sowie von internationalen Handelsverflechtungen (spatial carbon leakage) hat die Reduktion von CO₂-Emissionen in Deutschland Rebound-Effekte, wodurch in anderen Ländern mehr emittiert wird. Werden in De 100 Tonnen CO₂ eingespart, reduzieren sich die globalen CO₂-Emissionen nicht um 100 Tonnen, sondern um einen deutlich geringeren Wert.
> >
> > > **NOTE:**
> > >
> > > Innerhalb der EU wird die Menge von bestimmten Treibhausgasemissionen für bestimmte Branchen durch das Europäische Emissionshandelssystem gesetzlich reguliert. Die EU gibt THG-Zertifikate für eine Zeitperiode aus, die der genehmigten Emissionsmenge in dieser Periode entsprechen. Die Unternehmen dieser Branchen[^10] müssen sich die THG-Zertifikate in der Menge beschaffen, in der sie Treibhausgase emittieren. Wenn nun ein Stromerzeuger in Deutschland seine THG-Emissionen reduziert, so braucht es weniger THG-Zertifikate von der EU zu erwerben. Diese Zertifikate werden von anderen EU-Unternehmen erworben und diese Unternehmen emittieren mehr Treibhausgase als sie ohne die Einsparung des deutschen Stromerzeugers emittiert hätten. Die Emissionsmenge bleibt die gleiche, nämlich diejenige, die durch die EU vorgegeben ist.
> >
> > > **NOTE:**
> > >
> > > Wird der Preis eines CO₂-intensiven Produkts durch eine CO₂-Steuer in einem Land erhöht, wird es relativ preiswerter, dieses Produkt in Ländern mit geringeren Steuern zu produzieren. Auf diese Weise führt eine Reduktion der THG-Menge durch eine höhere Besteuerung von CO₂-Emissionen dazu, dass in anderen Ländern mehr THG emittiert werden.\[eine ausführlichere Darstellung findet sich in [Abschnitt 12.6.3.1](https://www.ipcc.ch/report/ar6/wg3/chapter/chapter-12/) des 6. Sachstandsberichts des Weltklimarates, Arbeitsgruppe 3.\]
>
...
> **TIP:**
>
> Klimapolitischer Alleingang Deutschlands hat zur Folge, dass jede in Deutschland eingesparte Einheit an Treibhausgasemissionen die globalen Treibhausgasemissionen um weniger als diese Einheit reduziert[^11].
>
> > **TIP:**
> >
...
> >     - das derzeit geltende EU-ETS-1 reguliert etwa 40% aller CO₂-Emissionen der EU ([Quelle](https://www.dehst.de/DE/Themen/EU-ETS-1/EU-ETS-1-Informationen/EU-ETS-1-verstehen/eu-ets-1-verstehen_node.html))
> >     - das 2028 in Kraft tretende [EU-ETS-2](https://www.dehst.de/DE/Themen/nEHS/EU-ETS-2/eu-ets-2-berichtsphase-2024-2026/eu-ets-2_artikel.html?nn=596922#doc596926bodyText1) erweitert die Begrenzung der Emissionen auf die Sektoren Straßenverkehr und Wohnen. Damit sollen nach vorläufigen Schätzungen etwa 75% aller CO₂-Emissionen der EU reguliert sein ([Quelle](https://www.europarl.europa.eu/RegData/etudes/BRIE/2025/772878/EPRS_BRI(2025)772878_EN.pdf), dort S.1).
> >   - Die Wirkung der nationalen THG-Reduktionen hängt insofern entscheidend davon ab, in welchem Sektor die Treibhausgase reduziert werden. Wenn ich heute auf eine Autofahrt mit einem Verbrenner-Motor in Deutschland verzichte, spare ich Treibhausgasemissionen, die nicht vom Wasserbett-Effekt betroffen sind. Das wird ab 2028 anders sein. Da ein Instrument wie nationale CO₂-Steuer alle CO₂-Emissionen einschließt, ist ihre Wirkung abhängig von der Abdeckung des EU-Emissionshandelssystems:
> >     - nach aktuellem Recht dürften die nationalen THG-Reduktionen durch eine nationale CO₂-Steuer zu 40% verpuffen. Die restlichen 60% der Emissionsreduktion werden durch das EU-ETS nicht betroffen sein und es werden keine zusätzlichen Emissionen in anderen EU-Ländern induziert.
...
> > - Bezüglich der durch internationalen Handel möglichen Verlagerungen der CO₂-Emissionen (carbon leakage) sind genaue Schätzungen komplex und entsprechend unsicher. Gemäß dem letzten Bericht des Weltklimarates zeigten ex-post Auswertungen der bisherigen CO₂-Regulierungen, dass die Verlagerungseffekte nicht messbar bis gering waren ([IPCC AR6 WG3, 13.6.6.1, S.1393](https://www.ipcc.ch/report/ar6/wg3/chapter/chapter-13/).
>
...
>   - Wenn in De aktuell (im Jahr 2026) 100 Tonnen CO₂ weniger emittiert werden, reduzieren sich die globalen CO₂-Emissionen um etwa 60 Tonnen.
>   - Wenn in De im Jahr 2029 100 Tonnen CO₂ eingespart werden, reduzieren sich die globalen CO₂-Emissionen um etwa 25 Tonnen.
...
>
> - Verweis darauf, dass die Einnahmen aus einer CO₂-Besteuerung nach Gerechtigkeitsprinizipien verteilt werden könnten (S. 94).
> - Eine Abschätzung dessen, wie hoch die Einnahmen sein werden, welche Belastungen aus der CO2₂-Besteuerung resultieren können und ob die Einnahmen überhaupt ausreichen, um diese Belastungen zu kompensieren, führt die Stellungnahme nicht auf.
>
> > **IMPORTANT:**
> >
...
>
> - eine in Deutschland eingesparte Tonne an CO₂-Emissionen reduziert im Durchschnitt die globalen Emissionen um weniger als eine halbe Tonne und in naher Zukunft lediglich um rund 200 kg. Möglicherweise wird eine unilaterale Klimaschutzpolitik Nachahmung durch andere Staaten finden und damit eine höhere Wirkung entfalten.

> **WARNING:**
>
> Unilaterale Klimaschutzpolitik kann substantielle Belastungen für in Deutschland lebende Menschen mit sich bringen:
>
> - mit einer unilateralen Besteuerung von CO₂-Emissionen in Deutschland steigen die Kosten für CO₂-intensive Wirtschaftsaktivitäten und damit für ihre Betreiber die Anreize, sie zu verlagern.
> - In Deutschland machen CO₂-intensive Wirtschaftsaktivitäten (Maschinenbau, Automobil- und Chemieindustrie) einen beträchtlichen Teil der nationalen Wertschöpfung aus.
...
>
> Für die Höhe der SCC finden sich stark abweichenden Angaben in der Fachliteratur [^12]:
>
> - 132\$/tCO₂ (2020 Preise): Mittelwert einer [Literaturauswertung](https://www.pnas.org/doi/10.1073/pnas.2410733121);
> - 283\$/tCO₂ (2020 Preise): Mittelwert einer [Schätzung](https://www.pnas.org/doi/10.1073/pnas.2410733121), die Kontroversen in der Literatur berücksichtigt;
> - 345€/tCO₂-Äq (2025-Preise): Schätzung des [Umweltbundesamtes](https://www.umweltbundesamt.de/system/files/medien/479/publikationen/2026-02/UBA_Handbuch%20Umweltkosten_Methodenkonvention%204.0.pdf)
> - 990€/tCO₂-Äq (2025-Preise): Schätzung des [Umweltbundesamtes](https://www.umweltbundesamt.de/system/files/medien/479/publikationen/2026-02/UBA_Handbuch%20Umweltkosten_Methodenkonvention%204.0.pdf) bei Annahme einer Zeitpräferenzrate von 0.

> **NOTE:**
>
> Der Ökonom [Daniel Bressler versucht zu schätzen](https://www.nature.com/articles/s41467-021-24487-w), wie viele Todesfälle die Emission einer zusätzlichen Tonne von CO₂ verursacht.
>
> - nach seinen Schätzungen hat die Emission einer Tonne CO₂ Mortalitätskosten in Höhe von 0.000226.
...
| Emissionen De 2025 | Klimaschutzeingriff (Annahme) | THG-Reduktion national | THG-Reduktion global |  |
|:--:|:--:|:--:|:---|:--:|
| [648,903 Millionen Tonnen CO₂e](https://www.umweltbundesamt.de/daten/umweltzustand-trends/klima/treibhausgas-emissionen-in-deutschland#entwicklung-der-treibhausgase-kohlendioxid-methan-distickstoffoxid) | Reduktion der THG-Emissionen um 5% | 32,45 Millionen Tonnen CO₂e weniger | ETS-1 (bis 2028) | 19,468 Millionen Tonnen CO₂e |
|  |  |  | ETS-2 (ab 2028) | 8,11 Millionen Tonnen CO₂e |

## Bewertung der Wirkungen

> **NOTE:**
>
> | Globale Reduktionsmenge | SCC-Wert | **Vermiedene gesamtgesellschaftliche Kosten** |
> |----|----|----|
> | 19,468 Millionen Tonnen CO₂e (ETS-1) | 132 \$/Tonne (min) | **2,6 Milliarden \$** |
> |  | 990 \$/Tonne (max) | **19,3 Milliarden \$** |
> | 8,11 Millionen Tonnen CO₂e (ETS-2) | 132 \$/Tonne (min) | **1 Milliarde \$** |
> |  | 990 \$/Tonne (max) | **8 Milliarden \$** |

> **NOTE:**
>
> | Globale Reduktionsmenge | MCC-Wert | **Vermiedene gesamtgesellschaftliche Kosten** |
> |----|----|----|
> | 19,468 Millionen Tonnen CO₂e (ETS-1) | 0.000226 pro Tonne | **4400 Todesfälle** |
> | 8,11 Millionen Tonnen CO₂e (ETS-2) | 0.000226 pro Tonne | **1800 Todesfälle** |
...
> **WARNING:**
>
> Wir können uns vergegenwärtigen, wann die Kosten der Maßnahmen, mit denen 5% der THG-Emissionen von 2025 eingespart werden, unverhältnismäßig hoch wären: \* Wenn wir das [normative Hintergrundprinzip](#normativer-hintergrund-prinzip-für-die-gerechte-verteilung-von-vorteilen-und-lasten) “Gleichverteilung als Maximalbelastung” unterstellen, müssten Maßnahmen, die zu einer Einsparung von 5% der THG-Emissionen von 2025 führen, \* gesamtgesellschaftliche Kosten verursachen, die **höher liegen als die geschätzten 1-19 Milliarden \$** an gesamtgesellschaftlichem Nutzen oder \* zu mehr als **1800-4400 zusätzlichen Todesfällen** führen.
>
> Mir sind keine Schätzungen der gesamtgesellschaftlichen Kosten von unilateraler Klimaschutzpolitik bekannt. Doch ich kann mir nicht vorstellen, dass die gesamtgesellschaftlichen Kosten aus der Einsparung von 30 Millionen Tonnen CO₂ in Deutschland derart hohe gesamtgesellschaftliche Kosten verursachen (mir ist kein Mechanismus bekannt, wie dies zustande kommen kann). Bisherige Einsparungen von Treibhausgasemissionen scheinen nicht solche Kosten aufgebürdet zu haben.
...
> > **CAUTION:**
> >
> > - Eine unilaterale Klimaschutzmaßnahme wie eine CO₂-Steuer macht Treibhausgase emittierende Aktivitäten teurer:
...
> > >
> > > - Hier liegt das **Kontrollierbarkeits-Vorsorgeprinzip** als Entscheidungsprinzip zugrunde[^13]. Seine Grundintuition lautet:
> > >
...
[^3]: Frauke Rostalski war als Mitglied des Ethikrats an der Stellungnahme “Klimagerechtigkeit” beteiligt, hat dort, zusammen mit zwei weiteren Mitgliedern, ein Sondervotum abgegeben, in dem sie die Empfehlung zu nationalen Alleingängen in der Klimapolitik kritisiert.

[^4]: vgl. hierzu den Abschnitt “Dann doch lieber Gesinnungsethik? Zur Stellungnahme ‘Klimagerechtigkeit’ des Deutschen Ethikrats” in ihrem Buch [Wer soll was tun? Warum wir nicht zum Klimaschutz verpflichtet sind und worin unsere Verantwortung eigentlich besteht](https://www.chbeck.de/rostalski-tun/product/38808807) (S. 68-74). Darin bezeichnet sie die vom Ethikrat vertretene Position als “Gesinnungsethik” und beurteilt sie als “nachgerade fahrlässig”, “totes Pferd” (S.73), zeitverschwenderisch: “\[…\] während die Gesinnungsethik mit ihrem erhobenen Zeigefinger bloß Zeit kostet, die wir schlicht nicht haben.”

[^5]: Sein-Sollen-Fehlschluss und Kategorienfehler zu begehen

[^6]: d.h. seine Treibhausgas-Emissionen in Einklang mit den aus dem Pariser-Abkommen resultierenden nationalen/europaweiten Verpflichtungen reduzieren soll (Reduktion der THG-Emissionen auf netto Null bis spätestens 2050)

[^7]: beispielsweise Einführung/Erhöhung einer Treibhausgassteuer im Inland

[^8]: z.B. “Eingriffe in die individuelle Freiheit der Bürger lassen sich auf dieser Basis kaum legitimieren; sie sind in Ermangelung einer Eignung zur Erreichung des erklärten Ziels Klimaschutz schlicht nicht verhältnismäßig.” (Ethikrat, Sondervotum, S. 114).

[^9]: z.B. Wenn in De 100 Tonnen CO2 weniger emittiert werden, reduzieren sich die globalen CO2-Emissionen um 100 Tonnen.

[^10]: (derzeit (ETS-1): Strom- und Wärmeerzeugung, Energie-intensive Industrie, Luftfahrt (seit 2012) sowie Schifffahrt (seit 2024), [hier](https://climate.ec.europa.eu/eu-action/carbon-markets/eu-emissions-trading-system-eu-ets/scope-eu-ets_en) findet sich eine vollständige Auflistung

[^11]: z.B. Wenn in De 100 Tonnen CO₂ weniger emittiert werden, reduzieren sich die globalen CO₂-Emissionen um weniger als 100 Tonnen.

[^12]: Dies resultiert daraus, dass die Höhe der SCC von normativen Annahmen wie Höhe der Zeitpräferenzrate

[^13]: Das Kontrollierbarkeits-Vorsorgeprinzip habe ich in folgenden Aufsätzen diskutiert: [Pissarskoi 2018](https://academic.oup.com/book/6645/chapter-abstract/150676247?login=false&redirectedFrom=fulltext) und [Pissarskoi unpublished](https://nextclouds.webo.hosting/s/tPKYJrs3RjJpPme)
