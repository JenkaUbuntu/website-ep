...
> **NOTE:**
>
> Um reflektierte Handlungsorientierung in Bezug auf Nachhaltige Entwicklung zu erlangen – d.h. begründet zu entscheiden, was ich als Individuum, wir als Organisation, Nationalstaat oder Menschheit tun sollen, um sowohl intergenerationell als auch global gerecht zu leben – müssen die Konsequenzen unseres Handelns vorhergesagt und bewertet werden:
>
...
>   - Es kann nicht eindeutig bestimmt werden, wie stark sich gesellschaftlich relevante Größen wie Oberflächentemperatur, Meeresspiegelanstieg, Veränderung von Niederschlägen etc. in Abhängigkeit von einer bestimmten Treibhausgaskonzentration in der Atmosphäre verändern[^1].
...
>
> **Gesellschaftliche Kontroversen** über die Ziele und Strategien Nachhaltiger Entwicklung resultieren jedoch vielfach daraus, dass
>
...
>
> So treibt mich die Frage um, wie eine reflektierte Entscheidungsfindung angesichts der beschriebenen wissenschaftlichen Lücken und der damit zusammenhängenden akademischen und politischen Kontroversen erfolgen sollte.

## Forschungsthemen

### Aus Eigeninteresse verfolgt

Handeln im Lichte von Ungewissheiten

Vorstellungen guten Lebens

Methoden politischer Beratung
...
Die [aus Eigeninteresse verfolgten Forschungsfragen](forschung.llms.md#aus-eigeninteresse-verfolgten-forschungsthemen) haben sich mir wiederum gestellt, weil von ihren Antworten unser Umgang mit bestehenden gesellschaftlichen Herausforderungen –
...
abhängt. Entsprechend habe ich die theoretischen Fragen vielfach am Beispiel von tatsächlich bestehenden [gesellschaftspolitischen Debatten und Kontroversen](forschung.llms.md#gesellschaftspolitisch-motivierte-themen) diskutiert.

Zurück nach oben

## Fußnoten

[^1]: [Klimasensitivität](https://www.ipcc.ch/report/ar6/wg1/chapter/chapter-7/#faq-7-3) beschreibt, wie stark sich die Oberflächentemperatur langfristig verändert, nachdem sich die Treibhausgaskonzentration in der Atmosphäre verdoppelt hat. Der 6. Bericht des Weltklimarates gibt die [Bandbreite zwischen 1,5 und 7,7°C als “sehr wahrscheinlich”](https://www.ipcc.ch/report/ar6/wg1/chapter/chapter-7/#7.5.5) an.
