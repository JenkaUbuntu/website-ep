...
[^1]: Deutschland emittiert etwa 2% der globalen Treibhausgasemissionen. Für die Begrenzung der Erderwärmung auf 1,5-2° C müssten die globalen jährlichen THG-Emissionen von etwa 55 Gt CO~2~-Äquivalente auf rund 10-15 Gt, also um etwa 80% sinken (Schätzungen aus dem 6. Sachstandsbericht des IPCC, Working Group 3, Abschnitt 3.3, [Graphik 3.10](https://www.ipcc.ch/report/ar6/wg3/figures/chapter-3/figure-3-5)). Deutschland hat 2025 rund 0,65 Gt CO~2~e emittiert. 
...
<!--
Unternehmen und Bürger\*innen durch gesetzliche Regulierung dazu bewegt werden, Treibhausgasemissionen zu reduzieren, solange es international keine verlässliche Aussicht darauf besteht, dass hinreichend viele andere Staaten ebenfalls ihre THG-Emissionen reduzieren?-->
...
[**Ja!**]{style="color:#2ca25f"} schreibt der Deutsche Ethikrat in seiner [Stellungnahme Klimagerechtigkeit](Gutachten Klimagerechtigkeit).^["Auf nationaler Ebene muss dafür Sorge getragen werden, dass die mit der Pariser Klimakonvention von Deutschland eingegangenen Verpflichtungen rasch und effektiv erfüllt werden." (S. 105), siehe auch Diskussion auf S.93f.]
...
::: {.column width="44%"}
 ...
 [**Nein!**]{style="color:#FFA44F"} [schreiben die Ökonomen Axel Ockenfels und Christoph M. Schmidt](https://www.degruyterbrill.com/document/doi/10.1515/zfwp-2019-2017/html) sowie die [Rechtswissenschaftlerin Frauke Rostalski](https://rostalski.jura.uni-koeln.de/prof-dr-dr-frauke-rostalski)^[Frauke Rostalski war als Mitglied des Ethikrats an der Stellungnahme "Klimagerechtigkeit" beteiligt, hat dort, zusammen mit zwei weiteren Mitgliedern, ein Sondervotum abgegeben, in dem sie die Empfehlung zu nationalen Alleingängen in der Klimapolitik kritisiert.]. 
...
* So wirft Rostalski den Befürworter*innen der Stellungnahme des Ethikrates vor, eine moralische Position zu vertreten, die dem gesunden Menschenverstand widerspricht: Gesinnungsethik ohne Rücksicht auf die Konsequenzen eigenen Handelns^[vgl. hierzu den Abschnitt "Dann doch lieber Gesinnungsethik? Zur Stellungnahme 'Klimagerechtigkeit' des Deutschen Ethikrats" in ihrem Buch [Wer soll was tun? Warum wir nicht zum Klimaschutz verpflichtet sind und worin unsere Verantwortung eigentlich besteht](https://www.chbeck.de/rostalski-tun/product/38808807) (S. 68-74). Darin bezeichnet sie die vom Ethikrat vertretene Position als "Gesinnungsethik" und beurteilt sie als "nachgerade fahrlässig", "totes Pferd" (S.73), zeitverschwenderisch: "[...] während die Gesinnungsethik mit ihrem erhobenen Zeigefinger bloß Zeit kostet, die wir schlicht nicht haben."];
...
```{=html}
<iframe src="./rekos/vorreiter-pro-arg1.component.html" width="100%" height="300px">
</iframe>
```
...
::: {.column width="50%"}
::: {.callout-note icon="false" collapse="true"}
#### keine Nachahmung der Vorreiter-Rolle
...
Klimapolitischer Alleingang^[beispielsweise Einführung/Erhöhung einer Treibhausgassteuer im Inland] eines Staates wie Deutschland führt dazu, dass wirksamer globaler Klimaschutz -- beispielsweise Erreichen des Pariser Klimaschutzziels -- induziert wird.
...
* Ich vermute, dass hierüber auch Einigkeit zwischen den Protagonisten besteht. 
  ...
  * Die Gegner\*innen suggerieren in manchen Formulierungen, den Befürworter\*innen diese starke These zu unterstellen^[z.B. "Eingriffe in die individuelle Freiheit der Bürger lassen sich auf dieser Basis kaum legitimieren; sie sind in Ermangelung einer Eignung zur Erreichung des erklärten Ziels Klimaschutz schlicht nicht verhältnismäßig." (Ethikrat, Sondervotum, S. 114).].
...
Klimapolitischer Alleingang Deutschlands hat zur Folge, dass jede in Deutschland eingesparte Einheit an Treibhausgasemissionen die globalen Treibhausgasemissionen um weniger als diese Einheit reduziert^[ z.B. Wenn in De 100 Tonnen CO~2~ weniger emittiert werden, reduzieren sich die globalen CO~2~-Emissionen um weniger als 100 Tonnen.].
...
[**Befürworter\*innen der Vorreiter-Rolle**]{style="color: #2ca25f;"}

scheinen eine proportionale Wirksamkeit zu unterstellen

<!--[diese Behauptung ist falsch]{style="color: #f33"}--> :x:
</div>
...
::: {.column width="44%"}
<div style="text-align: center;">
[**Gegner\*innen der Vorreiter-Rolle**]{style="color: #FFA44F"} 
...
::: {.column width="90%"}
Die empirisch haltbare Behauptung :white_check_mark: **"schwache Wirksamkeit"** findet sich hingegen weder in der Argumentation der Befürworter\*innen noch der Gegner\*innen.
:::
...
* Verweis darauf, dass die Einnahmen aus einer CO~2~-Besteuerung nach Gerechtigkeitsprinizipien verteilt werden könnten (S. 94). 
* Eine Abschätzung dessen, wie hoch die Einnahmen sein werden, welche Belastungen aus der CO2~2~-Besteuerung resultieren können und ob die Einnahmen überhaupt ausreichen, um diese Belastungen zu kompensieren, führt die Stellungnahme nicht auf.  


::: {.callout-important icon="false" collapse="true"}
### Beurteilung: keine nachvollziehbare Abwägung
...
::: {.callout-important icon="false" collapse="true"}
### Beurteilung: Abwägung unplausibel
...
::: {.callout-note icon="false" collapse="true"}
### Ein Teil der geführten Kontroverse ist unnötig
...
sind unpräzise in ihrer Einschätzung der Wirkungen -- möglicherweise überschätzen sie die Klimaschutzwirkung einer unilateralen Klimapolitik. <!--Die Behauptung in der Prämisse 6 des Arguments für die unilaterale Klimapolitik, die Belastungen würden keine ungerechten Belastungen verursachen, bleibt unbegründet.-->
</div>
...
::: {.callout-note icon="false" collapse="true"}
### Relevante Kontroverse über die Verhältnismäßigkeit der unilateralen Klimaschutzpolitik wird nicht ausgetragen
...
* mit einer unilateralen Besteuerung von CO~2~-Emissionen in Deutschland steigen die Kosten für CO~2~-intensive Wirtschaftsaktivitäten und damit für ihre Betreiber die Anreize, sie zu verlagern. 
* In Deutschland machen CO~2~-intensive Wirtschaftsaktivitäten (Maschinenbau, Automobil- und Chemieindustrie) einen beträchtlichen Teil der nationalen Wertschöpfung aus. 
:::
...
```{=html}
<iframe src="./rekos/arg4-eig-kontr.html" width="100%" height="500px">
</iframe>
```
...
::: {.callout-note icon="false" collapse="true"}
#### Verteilungsprinzipien für die Beurteilung der Verhältnismäßigkeit
...
Für die Höhe der SCC finden sich stark abweichenden Angaben in der Fachliteratur ^[Dies resultiert daraus, dass die Höhe der SCC von normativen Annahmen wie Höhe der Zeitpräferenzrate]:
  ...
  * 990€/tCO~2~-Äq (2025-Preise): Schätzung des [Umweltbundesamtes](https://www.umweltbundesamt.de/system/files/medien/479/publikationen/2026-02/UBA_Handbuch%20Umweltkosten_Methodenkonvention%204.0.pdf) bei Annahme einer Zeitpräferenzrate von 0.
:::
...
Der Ökonom [Daniel Bressler versucht zu schätzen](https://www.nature.com/articles/s41467-021-24487-w), wie viele Todesfälle die Emission einer zusätzlichen Tonne von CO~2~ verursacht. 

 * nach seinen Schätzungen hat die Emission einer Tonne CO~2~ Mortalitätskosten in Höhe von 0.000226. 
:::
...
::: {.list-table aligns="c,c,c,l,c" tbl-colwidths="[20,20,20,20,20]"}

- - Emissionen De 2025
  - Klimaschutzeingriff (Annahme)
  - THG-Reduktion national
  - []{colspan=2} THG-Reduktion global

- - []{rowspan=2} [648,903 Millionen Tonnen CO~2~e](https://www.umweltbundesamt.de/daten/umweltzustand-trends/klima/treibhausgas-emissionen-in-deutschland#entwicklung-der-treibhausgase-kohlendioxid-methan-distickstoffoxid)
  - []{rowspan=2} Reduktion der THG-Emissionen um 5%
  - []{rowspan=2} 32,45 Millionen Tonnen CO~2~e weniger
  - ETS-1 (bis 2028)
  - 19,468 Millionen Tonnen CO~2~e

- - ETS-2 (ab 2028)
  - 8,11 Millionen Tonnen CO~2~e
...
| Gesamtemissionen Deutschland 2025 | Klimapolitischer Eingriff (Annahme) | Nationale Reduktionsmenge |
|:---------:|:-----:|:------:|
| [648,903 Millionen Tonnen CO~2~e](https://www.umweltbundesamt.de/daten/umweltzustand-trends/klima/treibhausgas-emissionen-in-deutschland#entwicklung-der-treibhausgase-kohlendioxid-methan-distickstoffoxid) | Reduktion der THG-Emissionen um 5% | 32,45 Millionen Tonnen CO~2~e weniger |

: {.striped .hover}

### Globale Wirkungen

::: {.list-table tbl-colwidths="[40,20,40]"}
- - Nationale Reduktionsmenge
  - []{colspan=2} Globale Reduktionsmenge

- - []{rowspan=2} 32,45 Millionen Tonnen CO~2~e
  - ETS-1 (bis 2028)
  - 19,468 Millionen Tonnen CO~2~e
...
::: {.list-table tbl-colwidths="[40,25,35]"}
- - Globale Reduktionsmenge
  - SCC-Wert
  - **Vermiedene gesamtgesellschaftliche Kosten**

- - []{rowspan=2} 19,468 Millionen Tonnen CO~2~e (ETS-1)
  - 132 $/Tonne (min)
  - **2,6 Milliarden $**
...
- - []{rowspan=2} 8,11 Millionen Tonnen CO~2~e (ETS-2)
  - 132 $/Tonne (min)
  - **1 Milliarde $** 
...
- - 19,468 Millionen Tonnen CO~2~e (ETS-1)
  - 0.000226 pro Tonne
  - **4400 Todesfälle**

- - 8,11 Millionen Tonnen CO~2~e (ETS-2)
  - 0.000226 pro Tonne
  - **1800 Todesfälle** 
...
::: {.callout-warning icon="false" collapse="true"}
#### Höhe der Belastungen durch den Klimaschutz, damit Unverhältnismäßigkeit greift

Wir können uns vergegenwärtigen, wann die Kosten der Maßnahmen, mit denen 5% der THG-Emissionen von 2025 eingespart werden, unverhältnismäßig hoch wären:
* Wenn wir das [normative Hintergrundprinzip](#normativer-hintergrund-prinzip-für-die-gerechte-verteilung-von-vorteilen-und-lasten) "Gleichverteilung als Maximalbelastung" unterstellen, müssten Maßnahmen, die zu einer Einsparung von 5% der THG-Emissionen von 2025 führen,
  * gesamtgesellschaftliche Kosten verursachen, die **höher liegen als die geschätzten 1-19 Milliarden $** an gesamtgesellschaftlichem Nutzen oder 
  * zu mehr als **1800-4400 zusätzlichen Todesfällen** führen.

Mir sind keine Schätzungen der gesamtgesellschaftlichen Kosten von unilateraler Klimaschutzpolitik bekannt. Doch ich kann mir nicht vorstellen, dass die gesamtgesellschaftlichen Kosten aus der Einsparung von 30 Millionen Tonnen CO~2~ in Deutschland derart hohe gesamtgesellschaftliche Kosten verursachen (mir ist kein Mechanismus bekannt, wie dies zustande kommen kann). Bisherige Einsparungen von Treibhausgasemissionen scheinen nicht solche Kosten aufgebürdet zu haben.
:::


::: {.callout-warning icon="false" collapse="true"}
#### Argumentation unter Unsicherheit über die Höhe der Belastungen
...
::: {.callout-note icon="false" collapse="true"}
#### Positive Wirkungen des Klimaschutzes
...
* Eine unilaterale Klimaschutzmaßnahme wie eine CO~2~-Steuer macht Treibhausgase emittierende Aktivitäten teurer: 
...
::: {.callout-caution icon="false" collapse="true"}
#### Gegner\*innen der unilateralen Klimaschutzpolitik
...
::: {.callout-note icon="false" collapse="true"}
#### Befürworter\*innen der unilateralen Klimaschutzpolitik
...
::: {.callout-tip icon="false" collapse="true"}
#### Ungleichverteilung der Gefahren
...
* Hier liegt das **Kontrollierbarkeits-Vorsorgeprinzip** als Entscheidungsprinzip zugrunde^[Das Kontrollierbarkeits-Vorsorgeprinzip habe ich in folgenden Aufsätzen diskutiert: [Pissarskoi 2018](https://academic.oup.com/book/6645/chapter-abstract/150676247?login=false&redirectedFrom=fulltext) und  [Pissarskoi unpublished](https://nextclouds.webo.hosting/s/tPKYJrs3RjJpPme)]. Seine Grundintuition lautet:
...
```{=html}
<iframe src="./rekos/arg5-eigentl-kontr-dialektik.component.html" width="100%" height="370px">
</iframe>
```
